...
\item[(a)]
Find $c_a(t)$ and $c_b(t)$ in first-order perturbation theory,
for the case $c_a(0)=1$, $c_b(0)=0$.
Show that $\bigl|c_a^{(1)}\bigr|^2+\bigl|c_b^{(1)}\bigr|^2=1$, to first order in $\hat H'$.

\item[(b)]
There is a nicer way to handle this problem. Let
\begin{equation*}
...
\item[(c)]
Use the method in part (b) to obtain $c_a(t)$ and $c_b(t)$ in first-order
